<template>
  <div>
    <svg v-if="name === 'Github'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      <path
    ...
    <svg v-else-if="name === 'Twitter'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      <path
    ...
    >
      <mask id="prefix__a" maskUnits="userSpaceOnUse" x="3" y="1" width="14" height="19">
        <path
      ...
      <g mask="url(#prefix__a)">
        ...
        <path
          ...
          fill="#FFA000"
        />
        <path fill="url(#prefix__prefix__prefix__pattern0)" d="M3.064 4.7h8.915v11.333H3.064z" />
        <path d="M11.549 10.112L9.16 5.609 3.884 15.625l7.665-5.513z" fill="#F57C00" />
        <path fill="url(#prefix__prefix__prefix__pattern1)" d="M3.474 3.884H17.82v15.724H3.474z" />
        <path
      ...
      <defs>
        ...
        <pattern
          ...
          height="1"
        >
          <use xlink:href="#prefix__prefix__prefix__image0" transform="scale(.0115 .00893)" />
        </pattern>
        <pattern
          ...
          height="1"
        >
          <use xlink:href="#prefix__prefix__prefix__image1" transform="scale(.00714 .00645)" />
        </pattern>
        <image
